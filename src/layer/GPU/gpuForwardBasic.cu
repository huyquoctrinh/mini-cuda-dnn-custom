...
__host__ void GPUInterface::conv_forward_gpu_prolog(
    ...
    int maskSize = outputFeatureMapsQuantity * inputFeatureMapsQuantity * kernelSize * kernelSize * sizeof(float); // C * outputFeatureMapsQuantity filter Maps of size K*K
